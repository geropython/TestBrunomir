...
public class SecondSceneScript : MonoBehaviour
{
    ...
    private void ContinueStory()
    {
        ...
        var responses = new Dictionary<string, string>//TODO: COMPLETE TEXTS
        {
            ...
            {"112", "/emote:Happy//color:red//click//sound:hmm/God! Every time I stir, it changes color., Nathan"},
            {"113", "/emote:Normal//color:red/Not everything is possible in life. Well anyway, thank you., Nathan"},
            {"121", "/emote:Happy//color:red//click//sound:hmm/Delicious coffee but my cup breaks., Nathan"},
            ...
            {"212", "/emote:Normal//color:red/I'm drinking something disgusting, but I don't know why it's so ugly., Nathan"},
            ...
            {"232", "/emote:Normal//color:red/Impossible, I can't drink coffee without cups and this dirty spoon.Impossible, I can't drink coffee without cups and this dirty spoon., Nathan"},
            ...
            {"313", "/emote:Normal//color:red/I still have to stir with my finger but it's very bland."},
            ...
            {"323", "/emote:Normal//color:red/And what do I do now with this shattered cup?, Nathan"},
